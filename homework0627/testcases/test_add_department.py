...
from homework0627.utils.file_util import get_datas
...
class TestAddDepartment:
    ...
    @pytest.mark.parametrize("department",get_datas()['add_department']['success'])
    ...
    @pytest.mark.parametrize("department,error",get_datas()['add_department']['fail'])
